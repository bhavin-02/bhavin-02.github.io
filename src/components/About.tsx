...
import { User, Heart, Globe, Music, Gamepad2, Code2, Zap, Target } from "lucide-react";
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-white/70 max-w-2xl mx-auto text-lg">
            Passionate about creating innovative solutions and staying current with the latest industry trends
          </p>
        </motion.div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <Card className="glass border-white/10 hover:border-white/20 transition-all duration-300">
              <CardContent className="p-6">
                <h3 className="text-xl text-white mb-4">Professional Summary</h3>
                <div className="space-y-4 text-white/70 leading-relaxed">
                  <p>
                    Seeking a challenging role as a React / React Native Developer where I can leverage my expertise in creating 
                    efficient, scalable mobile applications and contribute to innovative projects.
                  </p>
                  <p>
                    Experienced React / React Native Developer with over 2 years of expertise in creating efficient, scalable 
                    mobile applications using ReactJs, React Native, JavaScript, and TypeScript. Proven track record in 
                    implementing complex animations and integrating various libraries to create smooth, engaging user 
                    experiences.
                  </p>
                  <p>
                    Dedicated to writing clean, maintainable code and staying updated with the latest industry 
