      ...
      projects: [
        {
          ...
          description:
            "Cutting-edge user interface toolkit with comprehensive set of customizable components styled by Tailwind CSS",
          techStack: ["React Native", "Tailwind CSS"],
        },
        {
          name: "Fashion App UI",
          description:
            "Complete shopping application UI with facilities like shopping applications, product pages, and shopping cart",
          techStack: ["React Native", "React Native Reanimated"],
        },
        {
          name: "Payment App UI",
          description:
            "Payment management application UI for managing all types of payments and expenses",
          techStack: ["React Native", "React Native Reanimated"],
        },
      ],
      icon: Code,
      ...
      projects: [
        {
          ...
          description:
            "Feature-rich social networking app for cannabis enthusiasts, incorporating real-time messaging and community forums",
          techStack: [
            "React",
            "React Native",
            "AWS DynamoDB",
        ...
        },
        {
          ...
          description:
            "Dynamic poll creation and voting platform, enabling users to gather insights and make informed decisions",
          techStack: [
            "React Native",
            "AWS PostgreSQL",
            "Redux Toolkit",
        ...
        },
        {
          name: "Tiles Album",
          description:
            "Creative app for designing and sharing custom tile layouts, with cloud storage and social sharing features",
          techStack: [
            "React Native",
            "Django",
            "Redux Toolkit",
                ...
                <Card className="glass border-white/10 hover:border-white/20 transition-all duration-500 group overflow-hidden">
                  <CardHeader className="relative">
                    ...
                    <div className="absolute inset-0 opacity-5">
                      <div
                        className={`w-full h-full ${exp.color} rounded-t-lg`}
                      />
                    </div>
